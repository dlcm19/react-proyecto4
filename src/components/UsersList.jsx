  ...
  return (
    <article className='card__UserList' >
        ...
        <footer className='footer'>
            ...
            <button className='button_update' onClick={bottonUpdate}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
